...
Console.WriteLine("Введите несколько слов через символ слэш (/):  ");
...
array2= array2.Where(el => el != null).ToArray();
System.Console.WriteLine();
System.Console.WriteLine($"Было[{String.Join(";", array)}] стало [{String.Join(";", array2 )}] ");
